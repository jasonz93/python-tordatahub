...
class RestClient(object):
    ...
    def request(self, method, restmodel, **kwargs):
        ...
        req = tornado.httpclient.HTTPRequest(url=url, method=method, **kwargs)
        ...
        #         verify=False)
        resp = yield self._http_client.fetch(req)

        Logger.logger.debug('response.status_code: %d' % resp.code)
